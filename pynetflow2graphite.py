...
if __name__ == "__main__":
    ...
    parser.add_argument("--interface", "-i",  nargs='?', help="Local listening interface IP", default="0.0.0.0")
    parser.add_argument("--localport", "-p",  nargs='?', help="Local listening port", default=1514)
    parser.add_argument("--graphiteip", "-g",  nargs='?', help="Graphite server IP", default="127.0.0.1")
    parser.add_argument("--graphiteport", "-f", nargs='?', help="Graphite server port", default=2004)
